...
writes a skeleton of every Dart library it found, plus a report.
    ...
    python main.py --check                            just check the toolchain
...
from flutter_decompile import CAPABILITY, __version__  # noqa: E402
from flutter_decompile import apk as apk_mod           # noqa: E402
from flutter_decompile import blutter_driver as bd     # noqa: E402
from flutter_decompile import bootstrap                # noqa: E402
...
def main() -> int:
    ...
    from flutter_decompile import cli as fd_cli
